package com.bizhibihui.ordermeal.shiro;

import com.bizhibihui.ordermeal.config.properties.FileUploadProperties;
import com.bizhibihui.ordermeal.entity.Permission;
import com.bizhibihui.ordermeal.service.PermissionService;
...
public class ShiroService {
    ...
    public Map<String, String> loadFilterChainDefinitions() {
        ...
        filterChainDefinitionMap.put("/sitemap.txt", "anon");
        filterChainDefinitionMap.put("/robots.txt", "anon");
        filterChainDefinitionMap.put("/sitemap.html", "anon");
